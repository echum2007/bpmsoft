...
Не додумывать и не выдумывать. Если информация не найдена в базе знаний или PDF — прямо сказать «не нашёл, требует уточнения». Выдуманные факты об API или поведении платформы недопустимы: мы работаем с продуктивной системой.
