...
#### Шаг 2: Документация производителя (выбери первый доступный источник)

**🔴 ПРИОРИТЕТ — Уровень 1: NotebookLM**
- Инструмент: `mcp__notebooklm__ask_question` (ID: `bpmsoft-documentation`)
- 5-7x эффективнее по токенам, с цитатами из документации
- [Подробнее](knowledge/research-tools.md#-уровень-1-notebooklm-приоритет-для-документации)

**🟡 FALLBACK — Уровень 2: edu.bpmsoft.ru**
- Инструмент: `/bpmsoft-kb` скилл (Playwright MCP)
- Если NotebookLM недоступен или нужна информация, которой нет в блокноте
- [Подробнее](knowledge/research-tools.md#-уровень-2-edubpmsoftru-fallback-1-для-документации)

**🟠 FALLBACK — Уровень 3: Локальный PDF**
- Инструмент: Read tool на `Documentation 1.9/`
- Только если сеть полностью недоступна
- Индекс: `knowledge/DOCUMENTATION_INDEX.md`
- [Подробнее](knowledge/research-tools.md#-уровень-3-локальный-pdf-fallback-2-для-документации)

#### Шаг 3: Комбинирование источников

- Основа от документации производителя (Уровни 1-3)
- Дополнение и контекст от базы знаний (вики + memory)
- **Если найдёшь противоречие между документацией и вики** → сообщи, обсудим как исправить
