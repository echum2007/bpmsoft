	...
	return {
		...
		*/
		...
		details: /**SCHEMA_DETAILS*/{
			...
			"UsrSchema32d8c8f7Detaildff24be3": {
				"schemaName": "UsrSchema32d8c8f7Detail",
				"entitySchemaName": "ServiceInServicePact",
				"filter": {
					"detailColumn": "ServicePact",
					"masterColumn": "ServicePact"
				}
			}
		}/**SCHEMA_DETAILS*/,
		...
		diff: /**SCHEMA_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "CaseInformationTabGroupeb520010",
				"values": {
					"caption": {
						"bindTo": "Resources.Strings.CaseInformationTabGroupeb520010GroupCaption"
					},
					"itemType": 15,
			...
			{
				"operation": "insert",
				"name": "CaseInformationTabGridLayout71df97b2",
				"values": {
					"itemType": 0,
					"items": []
				},
				"parentName": "CaseInformationTabGroupeb520010",
				"propertyName": "items",
				"index": 0
			},
			{
				"operation": "insert",
				"name": "LOOKUP160668b8-1e84-48bb-88eb-2bdcb1d4b294",
				"values": {
					"layout": {
						"colSpan": 11,
						"rowSpan": 1,
						"column": 0,
						"row": 0,
						"layoutName": "CaseInformationTabGridLayout71df97b2"
					},
					"bindTo": "UsrLookup1123415",
					"labelConfig": {
						"visible": false,
						"caption": {
							"bindTo": "Resources.Strings.LOOKUP160668b81e8448bb88eb2bdcb1d4b294LabelCaption"
						}
					},
					"tip": {
						"content": {
							"bindTo": "Resources.Strings.LOOKUP160668b81e8448bb88eb2bdcb1d4b294Tip"
						}
					},
					"enabled": false,
					"contentType": 5
				},
				"parentName": "CaseInformationTabGridLayout71df97b2",
				"propertyName": "items",
				"index": 0
			},
			{
			...
			{
				"operation": "insert",
				"name": "Tabdce6df3bTabLabelSLA",
				"values": {
					"caption": {
						"bindTo": "Resources.Strings.Tabdce6df3bTabLabelSLATabCaption"
					},
					"items": [],
					"order": 8
				},
			...
			{
				"operation": "insert",
				"name": "UsrSchema32d8c8f7Detaildff24be3",
				"values": {
					"itemType": 2,
					"markerValue": "added-detail"
				},
				"parentName": "Tabdce6df3bTabLabelSLA",
				"propertyName": "items",
				"index": 0
			},
			{
